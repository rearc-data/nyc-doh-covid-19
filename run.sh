...
DATASET_NAME='nyc-doh-covid-19'
DATASET_ARN='arn:aws:dataexchange:us-east-1:796406704065:data-sets/c4424ccca06a8f1b51153d945f5742d1'
PRODUCT_NAME='NYC Coronavirus (COVID-19) Data | New York City Department of Health'
PRODUCT_ID='prod-bjfm2rjszqujm'
SCHEDULE_CRON="cron(0 22 * * ? *)"
REGION='us-east-1'
PROFILE='default'
